...
if(!message.member.roles.cache.some(r => [(ayarlar.registeryetki)].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply(`Bu komutu sadece yetkililer kullanabilir!!!`)
