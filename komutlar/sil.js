...
exports.run = async(yashinu, message, args) => {
  if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send(new Discord.MessageEmbed().setColor("BLUE").setDescription(`**\<a:nani:855858609790124072> | Bu komutu kullanabilmek için gerekli yetkiye sahip değilsin!**`)).then(beta => beta.delete({timeout: 3000}));
